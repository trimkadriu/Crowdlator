...
<div class="container" style="margin-top:80px;">
    <div>
        <h3>Contribute by audio recording this translated text</h3>
        <div class="span6" style="margin-left:0px;">
            <strong>Translated text from <?php echo $translate_from; ?> to <?php echo $translate_to; ?>:</strong><br/>
            <textarea disabled="disabled" class="translate_text" style="width: 95%; height: 150px; margin-top: 5px;"><?php echo $translated_text; ?></textarea><br/><br/>
    ...
    <div class="round-border" style="display: inline-block; padding: 10px; width: 98%; background-color: rgba(83,139,255,0.32)">
...
<script>
    ...
    function twitter_share() {
        window.open('https://twitter.com/intent/tweet?text=' + encodeURIComponent('Please contribute by recording audio for this translated text <?php echo $hash; ?> ') +
