...
<div class="container round-border">
    <h3 style="margin-left:20px;">Edit details for "<?php echo $project->project_name; ?>" project</h3><hr/>
        ...
        <div class="control-group"><?php
            ...
            <div class="controls"><?php
                $input_projectname = array('type' => 'text', 'name' => 'project_name', 
                                    ...
                                    'class' => 'input-block-level', 'value' => $project->project_name);
        ...
        <div class="control-group"><?php
            ...
            <div class="controls"><?php
                $input_projectname = array('type' => 'text', 'name' => 'project_description', 
                                    ...
                                    'class' => 'input-block-level', 'value' => $project->project_description);
        ...
        <div class="control-group"><?php
            ...
            <div class="controls"><?php
                $input_hashtags = array('type' => 'text', 'name' => 'hashtags',
                    ...
                    'class' => 'input-block-level', 'value' => $project->hash_tags);
