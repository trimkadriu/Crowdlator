...
function check_permissions($role_id, $permission)
{
	...
	if($CI->session->userdata('loggedin') === 'true')
	{
		...
		if($CI->users_model->check_permissions($role_id, $permission))
			return true;
		else
			return false;
	}
...
function get_user_role()
{
    $CI =& get_instance();
    $CI->load->model("users_model");
    $role = $CI->users_model->get_user_role();
    if($role)
        return $role;
    else
        return false;
...
function get_session_message()
{
	...
	{
		$message_data['message_type'] = $CI->session->flashdata('message_type');
		$message_data['message'] = $CI->session->flashdata('message');
		return $message_data;
	}
	else
		return false;
...
function check_login()
{
	...
	if($CI->session->userdata('loggedin') != 'true')
	{
		...
		$CI->session->set_flashdata('message', 'You are not logged in. Please login to enter administration panel.');
		redirect('pages/home/');
	}
}
...
function get_html_country_dropdown_list()
{
    $html = '<div class="control-group">'.
                ...
                <select name="country" class="input-block-level" required="required">
